...
def main(args):
    ...
    for i in range(len(cfg.trainset_3d)):
        exec('from datasets.' + cfg.trainset_3d[i] +
             ' import ' + cfg.trainset_3d[i])
    for i in range(len(cfg.trainset_2d)):
        exec('from datasets.' + cfg.trainset_2d[i] +
             ' import ' + cfg.trainset_2d[i])
    for i in range(len(cfg.trainset_humandata)):
        exec('from datasets.' + cfg.trainset_humandata[i] +
             ' import ' + cfg.trainset_humandata[i])
